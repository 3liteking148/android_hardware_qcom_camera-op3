...
int main() {
    ...
    PRINT(CAM_INTF_PARM_FACE_BEAUTY_LEVEL,    pMetadata);
    PRINT(CAM_INTF_PARM_FACE_INFO,    pMetadata);
    ...
    PRINT(CAM_INTF_META_FV,    pMetadata);
    PRINT(CAM_INTF_META_FRAME_SKIP,    pMetadata);
